...
public sealed class Worker(
    ...
    private static IReadOnlyList<DatProviderKind> ResolveProviders(IEnumerable<string> configured) {
        ...
        if (output.Count == 0) {
            return [DatProviderKind.Tosec, DatProviderKind.GoodTools, DatProviderKind.NoIntro, DatProviderKind.Mame, DatProviderKind.Mess, DatProviderKind.Redump, DatProviderKind.PleasureDome];
        }
